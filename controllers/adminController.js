...
const updateUser = async (req,res) => {
    const { id } = req.params
    const { name, email, mno, is_varified } = req.body
    try{
...
const createUser = async(req,res)=>{
    ...
    try{
        ...
        if(userData){
            res.render('admin/createUser',{message:"User already exist."})
        }
        else if(!userData){
            user.save()
            res.render('admin/createUser',{message:"Create new user has been successfull."})
            
             req.session.user = user._id;
        }else{
            res.render('admin/createUser',{message:'Create new use has been failed.'})
        }
